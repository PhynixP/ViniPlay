...
# Keep the default root runtime for compatibility with existing installs whose
# bind-mounted /data and /dvr files are root-owned. A prior non-root USER change
# made upgraded containers crash on startup with EACCES opening /data/logs/*.
