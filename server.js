...
function getSettings() {
    const defaultSettings = {
        ...
        streamProfiles: [
            ...
            { id: 'ffmpeg-intel', name: 'ffmpeg (Intel QSV)', command: '-user_agent "{userAgent}" -hwaccel qsv -hwaccel_output_format qsv -i "{streamUrl}" -vf vpp_qsv=format=nv12 -c:v h264_qsv -preset medium -global_quality 23 -c:a aac -b:a 128k -f mpegts pipe:1', isDefault: false },
        ...
        dvr: {
            ...
            recordingProfiles: [
                ...
                { id: 'dvr-mp4-intel', name: 'Intel QSV MP4 (H.264/AAC)', command: '-user_agent "{userAgent}" -hwaccel qsv -hwaccel_output_format qsv -i "{streamUrl}" -vf vpp_qsv=format=nv12 -c:v h264_qsv -preset medium -global_quality 23 -c:a aac -ac 2 -b:a 128k -movflags +faststart -f mp4 "{filePath}"', isDefault: false },
        ...
        castProfiles: [
            ...
            { id: 'cast-intel', name: 'Cast (Intel QSV)', command: '-user_agent "{userAgent}" -hwaccel qsv -hwaccel_output_format qsv -i "{streamUrl}" -vf vpp_qsv=format=nv12 -c:v h264_qsv -preset medium -global_quality 23 -c:a aac -b:a 128k -movflags frag_keyframe+empty_moov+default_base_moof -f mp4 pipe:1', isDefault: false },
